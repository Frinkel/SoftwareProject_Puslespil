...
public class PuzzleSolver {
	...
	public float puzzleSolvers(Object[] pieceList) {
		...
		Object[] adjacencyAndMatchingArray = produceAngleLengthPairs(AncleLengthPieceList, (ArrayList<Integer>) groups[0], (ArrayList<Integer>) groups[1],
				(ArrayList<Integer>) groups[2], (int) groups[3], (int) groups[4], (int) groups[5]);
...
// make sure to group correctly
	...
	private Object[] produceAngleLengthPairs(Object[] AncleLengthPieceList, ArrayList<Integer> gr1, ArrayList<Integer> gr2,
			ArrayList<Integer> gr3, int gr1Length, int gr2Length, int gr3Length) {
